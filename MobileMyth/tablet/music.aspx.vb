...
Partial Class tablet_music
    Inherits System.Web.UI.Page

    Private Shared Logger As log4net.ILog = log4net.LogManager.GetLogger(GetType(tablet_music))

    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Master.PageTitle = "Music"
        ...
        Try
            ...
            If Not String.IsNullOrEmpty(Folder) Then
                Dim url As String = "music.aspx"
                If Folder.Contains("/") Then
                    url &= "?f=" & Folder.Substring(0, Folder.LastIndexOf("/"))
                End If
                Dim Li As New GalleryPanel(0, url, "../images/119.png", "..")
            ...
            For i As Integer = FolderStartIndex To Folders.Count - 1 + FolderStartIndex
                Dim Li As New GalleryPanel(i, "music.aspx?f=" & Folders(i - FolderStartIndex), "../images/119.png", Folders(i - FolderStartIndex))
                maincontent.Controls.Add(Li)
            Next
